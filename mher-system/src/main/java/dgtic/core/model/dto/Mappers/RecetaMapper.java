...
public class RecetaMapper {
    ...
    public static RecetaResponse ToDto(Recetario recetario) {
        ...
        if (recetario.getDoctor() != null && recetario.getDoctor().getEspecialidad() != null) {
            receta.setDoctor(DoctorMapper.OnlyNameToDto(recetario.getDoctor()));

            if (recetario.getDoctor().getEspecialidad() != null) {
                receta.setEspecialidad(
                        EspecialidadMapper.ToDto(
                                recetario.getDoctor().getEspecialidad()
                        )
                );
            }
        }
        ...
        if (recetario.getPaciente() != null) {
            receta.setPaciente(
                    PacienteMapper.ToDto(recetario.getPaciente())
            );
        }
